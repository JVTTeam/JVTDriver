...
static const char *my_controller_main_settings_section = "driver_jvt";

// Individual right/left hand settings sections
static const char *my_controller_right_settings_section = "driver_jvt_left_controller";
static const char *my_controller_left_settings_section = "driver_jvt_right_controller";
...
vr::EVRInitError ControllerDeviceDriver::Activate( uint32_t unObjectId )
{
	...
	vr::VRDriverInput()->CreateScalarComponent( container, "/input/finger/index", &input_handles_[ Component_indexFinger ], vr::VRScalarType_Absolute, vr::VRScalarUnits_NormalizedOneSided );
	vr::VRDriverInput()->CreateScalarComponent( container, "/input/finger/middle", &input_handles_[ Component_middleFinger ], vr::VRScalarType_Absolute, vr::VRScalarUnits_NormalizedOneSided );
	vr::VRDriverInput()->CreateScalarComponent( container, "/input/finger/ring", &input_handles_[ Component_ringFinger ], vr::VRScalarType_Absolute, vr::VRScalarUnits_NormalizedOneSided );
	vr::VRDriverInput()->CreateScalarComponent( container, "/input/finger/pinky", &input_handles_[ Component_pinkyFinger ], vr::VRScalarType_Absolute, vr::VRScalarUnits_NormalizedOneSided );
	...
	vr::EVRInputError err = vr::VRDriverInput()->CreateSkeletonComponent( container,								  // container
		...
		&input_handles_[ Component_skeleton ] // Bind the component to a handle.
	);
	...
	my_hand_simulation_ = std::make_unique< HandSimulation >();
...
//-----------------------------------------------------------------------------
void ControllerDeviceDriver::DebugRequest( const char *pchRequest, char *pchResponseBuffer, uint32_t unResponseBufferSize )
{
...
void ControllerDeviceDriver::MyInputThread()
{
	while ( is_active_ )
	{
		if ( frame_ >= 4000 )
		...
		vr::VRDriverInput()->UpdateSkeletonComponent( input_handles_[ Component_skeleton ], vr::VRSkeletalMotionRange_WithController, transforms, 31 );
		vr::VRDriverInput()->UpdateSkeletonComponent( input_handles_[ Component_skeleton ], vr::VRSkeletalMotionRange_WithoutController, transforms, 31 );
