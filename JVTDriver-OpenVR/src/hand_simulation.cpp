...
void HandSimulation::ComputeSkeletonTransforms(vr::ETrackedControllerRole role, const FingerCurls& curls, const FingerSplays& splays, vr::VRBoneTransform_t* out_transforms)
{
